...
export const updateBudgetById = (id, payload) =>
  api.put(`/budget/${id}`, payload);
...
export const updatePayeeById = (id, payload) =>
  api.put(`/payee/${id}`, payload);
